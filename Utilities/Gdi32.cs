...
namespace OutlineWF.Utilities
{
    ...
    public class Gdi32
    {
        ...
        [System.Runtime.InteropServices.DllImportAttribute("gdi32.dll")]
        private static extern IntPtr CreateSolidBrush(BrushStyles enBrushStyle);
        [System.Runtime.InteropServices.DllImportAttribute("gdi32.dll")]
        ...
        {
            InitPenAndBrush(g);
            MoveToEx(hdc, (int)p1.X, (int)p1.Y, (IntPtr)null);
        ...
        {
            InitPenAndBrush(g);
            Ellipse(hdc, (int)p1.X, (int)p1.Y, (int)p2.X, (int)p2.Y);
            Dispose(g);
        }
